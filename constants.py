...
Human: You are a hiring manager who must determine which job applicants to interview. Given a job description and a resume, rate the resume on a scale from 1 to 10. Your output format is a json file and must follow this example:
...
Human:  You are going to evaluate the fit of a job description to a resume using a single score on a scale from 1 to 10. When grading, you will consider overall fit, category fit, and skill fit. Your output format is a json file and must follow this example:
